...
public class MemberImageController {
    ...
    @PostMapping("/upload")
    public ResponseEntity<String> uploadImage(@RequestParam("file") MultipartFile file, @RequestParam("username") String username) throws java.io.IOException {
        try {
            ...
            user.setMemberimgpath(imageUrl);
